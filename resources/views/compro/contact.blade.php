    ...
    <main class="py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    ...
                    <p class="text-lg text-gray-600 max-w-3xl mx-auto">Kami siap membantu Anda dengan solusi teknologi terbaik. Hubungi kami untuk konsultasi.</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-8">
                        ...
                        <form class="space-y-6">
                            ...
                            <div>
                                <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Kirim Pesan</button>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="mt-1 text-gray-600">Jln. Musi RT 002/RW 001, Desa Sumberejo,<br> Kecamatan Sukodono, Kabupaten Lumajang<br>Jawa Timur, Indonesia</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="mt-1 text-gray-600">info@natatech.com</p>
                                </div>
                            </div>
                            ...
                            <div class="pt-6 mt-6 border-t border-gray-200">
                                ...
                                <div class="flex space-x-6">
                                    <a href="https://www.facebook.com/people/PT-Naraya-Satya-Utama/pfbid02t9NcZAJpkjcEoF2ZioG2aRHbe9CZPAywknkTUjWk3Qr3KfgaDVD3d8wFyibUHvnil/" class="text-gray-400 hover:text-gray-500">
                                        <span class="sr-only">Facebook</span>
                                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                                    <a href="https://www.instagram.com/ptnatatech/" class="text-gray-400 hover:text-gray-500">
                ...
                <div class="mt-12 bg-white rounded-lg shadow-md p-8">
                    ...
                    <div class="aspect-w-16 aspect-h-9">
                        ...
                        <div class="w-full h-96 bg-gray-200 rounded-lg flex items-center justify-center text-gray-500">
                            <iframe class="rounded-lg" src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d31598.3642938003!2d113.2323721!3d-8.1222888!3m2!1i1024!2i768!4f13.1!2m1!1sJln.%20Musi%20RT%20002%2FRW%20001%2C%20Desa%20Sumberejo%2C%20Kecamatan%20Sukodono%2C%20Kabupaten%20Lumajang%20Jawa%20Timur%2C%20Indonesia!5e0!3m2!1sid!2sid!4v1747570964732!5m2!1sid!2sid" width="1150" height="385" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
