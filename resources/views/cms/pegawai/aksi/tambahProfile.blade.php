<x-app-layout>
    ...
    @if (session('error'))
        <x-alert type="error" :message="session('error')" :duration="3000" />
    @endif
    ...
    <div class="min-h-screen bg-white dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md p-8">
            ...
            <form action="{{ route('tambah-profile') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <input type="text" id="nip_pegawai" name="nip_pegawai" value="{{ auth()->user()->nip }}"
                            readonly
                            class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 cursor-not-allowed" />
                    </div>
