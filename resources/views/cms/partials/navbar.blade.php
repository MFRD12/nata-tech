        ...
        <div class="flex justify-center flex-1 lg:mr-32">
            <div class="relative w-full max-w-xl mr-6 text-center">
                <div x-data="timeNow()" x-init="init()"
                    ...
                    <div class="text-blue-600 dark:text-blue-500 text-lg md:text-xl font-bold tracking-wide"
                        x-text="time">
                    </div>
                </div>
            </div>
          ...
          <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
            ...
            <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                    @click="toggleProfileMenu" @keydow.escape="closeProfileMenu" aria-label="Account"
                    aria-haspopup="true">
                    @php
                    ...
                    <img class="object-cover w-8 h-8 rounded-full"
                        src="{{ $foto ? asset('storage/' . $foto) : asset('images/profile.jpg') }}" alt="Foto Profil"
                        aria-hidden="true" />
                </button>
                <template x-if="isProfileMenuOpen">
                    <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        ...
                        <!-- Tombol Pilih Role -->
                        <form method="POST" action="{{ route('reset-active-role') }}" class="w-full">
                            @csrf
                            <li class="flex">
                                <button type="submit"
