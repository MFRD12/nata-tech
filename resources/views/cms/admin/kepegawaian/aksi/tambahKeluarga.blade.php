<x-app-layout>
    ...
    <div class="min-h-screen bg-white dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md p-8">
            ...
            <form id="keluargaForm" action="{{ route('tambah-keluarga') }}" method="POST">
                @csrf
                <!-- Pilih Pegawai -->
                <div class="mb-8">
                    ...
                    <select id="pegawai_id" name="pegawai_id" required onchange="enableStatusPernikahan()"
                        ...
                        @foreach ($pegawaiBelumPunyaKeluarga as $pegawai)
                    ...
                    <div class="flex space-x-6">
                        <label class="flex items-center">
                            <input type="radio" name="status_pernikahan" value="belum menikah"
                                ...
                                class="text-blue-600 focus:ring-blue-500 disabled:opacity-50" disabled>
