<x-app-layout>
    ...
    <div class="min-h-screen bg-white dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md p-8">
            <h2 class="text-3xl font-semibold text-gray-800 dark:text-white mb-8">Edit Data Keluarga</h2>

            @if (session('error'))
                <x-alert type="error" :message="session('error')" :duration="7000" />
            @endif

            <form id="keluargaForm" action="{{ route('update-keluarga', $keluarga->id) }}" method="POST">
                @csrf
                @method('POST')

                <div class="mb-8">
                    <label for="pegawai_nama_display" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Nama Pegawai</label>
                    <input type="text" id="pegawai_nama_display" value="{{ $keluarga->pegawai->nama ?? 'N/A' }}" readonly
                           class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400">
                ...
                <div id="orangtua_section" style="display: none;" class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_ayah" id="nama_ayah" value="{{ old('nama_ayah', $keluarga->nama_ayah ?? '') }}" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                        </div>
                        <div>
                            <label for="no_telp_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">No. Telepon Ayah</label>
                            <input type="text" name="no_telp_ayah" id="no_telp_ayah" value="{{ old('no_telp_ayah', $keluarga->no_telp_ayah ?? '') }}" maxlength="15" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                        </div>
                         <div>
                            ...
                            <select name="status_bekerja_ayah" id="status_bekerja_ayah" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                                <option value="">-- Pilih --</option>
                        ...
                        <div>
                            ...
                            <select name="status_ayah" id="status_ayah" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                                 <option value="">-- Pilih --</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_ibu" id="nama_ibu" value="{{ old('nama_ibu', $keluarga->nama_ibu ?? '') }}" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                        </div>
                        <div>
                            <label for="no_telp_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">No. Telepon Ibu</label>
                            <input type="text" name="no_telp_ibu" id="no_telp_ibu" value="{{ old('no_telp_ibu', $keluarga->no_telp_ibu ?? '') }}" maxlength="15" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                        </div>
                        <div>
                            ...
                            <select name="status_bekerja_ibu" id="status_bekerja_ibu" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                                <option value="">-- Pilih --</option>
                        ...
                        <div>
                            ...
                            <select name="status_ibu" id="status_ibu" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>
                                <option value="">-- Pilih --</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat_ortu" id="alamat_ortu" rows="3" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none" disabled>{{ old('alamat_ortu', $keluarga->alamat_ortu ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-10 flex justify-end space-x-4">
                    <a href="{{ route('view-keluarga') }}" {{-- Sesuaikan rute ini --}}
        ...
        function getChildFormTemplateForNew(tempKey) {
            return `
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Nama Anak</label>
                        <input type="text" name="anak[${tempKey}][nama]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">NIK</label>
                        <input type="text" name="anak[${tempKey}][nik]" maxlength="16" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Tempat Lahir</label>
                        <input type="text" name="anak[${tempKey}][tempat_lahir]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Tanggal Lahir</label>
                        <input type="date" name="anak[${tempKey}][tgl_lahir]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Jenis Kelamin</label>
                        <select name="anak[${tempKey}][gender]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih --</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Status Bekerja</label>
                        <select name="anak[${tempKey}][status_bekerja]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih --</option>
                     ...
                     <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Status Hidup</label>
                        <select name="anak[${tempKey}][status_hidup]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih --</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Status Anak</label>
                        <select name="anak[${tempKey}][status_anak]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih --</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Status Pernikahan Anak</label>
                        <select name="anak[${tempKey}][status_pernikahan]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">-- Pilih --</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Status Tanggungan</label>
                        <select name="anak[${tempKey}][status_tanggungan]" class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none">
